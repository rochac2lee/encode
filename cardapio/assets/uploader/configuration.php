...
class gatorconf {
	...
	public static function get($param) {
		...
		$config = array(
				...
				'use_database' => false,
				'db_host' => 'opmy0018.servidorwebfacil.com:3306',
				'db_username' => 'silva_db',
				'db_password' => 'vrpD2$86',
				'db_database' => 'silval_db',
				...
				// email configuration
				'mail_from' => 'no-reply@cimbessul.com.br',
				'mail_from_name' => 'Drive Cimbessul',
				'mail_signature' => "\n\nAtenciosamente,\nEmail Automático\Drive Cimbessul",

				// use smtp? (true/false)
				// if false php mail() will be used
				'use_smtp_protocol' => true,

				// smtp mail protocol settings
				'mail_smtp_host' => 'webmail.cimbessul.com.br',
				'mail_smtp_username' => 'no-reply@cimbessul.com.br',
				'mail_smtp_password' => 'ti123!@#TI',
				'mail_smtp_connection_security' => '', // 'tls', 'ssl' or '' for no security
