...
$(document).ready(function() {
    ...
    $('a.version-info').click(function(){
    	...
    	$('#modal').html(' ');
 		...
 		var output = '<div class="modal-content"><h5>Drive Cimbessul</h5><hr />';
 		output += '<p>Desenvolvido pelo Departamento de TI da CIMBESSUL S. A. em 2018.</p><p>Essa aplicação serve para organização de arquivos e dados de usuários, afim de organização corporativa.</p><p>Para mais informações entre em contato com o setor de TI pelos ramais 5007 ou 5023.</p></br><p style="float:right;">Equipe de TI</p>';
    ...
    $('a.username-edit').click(function(){
    	...
    	$('#modal').html(' ');
 		...
 		output += '<div class="modal-buttons right">';
 		output += '<button id="confirm-button" type="button" class="nice radius button btn btn-raised btn-warning"><?php echo lang::get("Change")?></button>';
    ...
    $('.delete-selected').click(function(){
    	...
    	output += '<div class="modal-buttons">';
    	output += '<button id="confirm-button" style="width: 45%;" type="button" class="nice alert radius button left btn btn-raised btn-warning"><?php echo lang::get("Delete")?></button>';
    	output += '<button id="cancel-button" style="width: 45%;" type="button" class="nice radius button right btn btn-raised btn-secondary"><?php echo lang::get("Cancel")?></button>';
    	output += '</div>';
    	output += '<a class="close-reveal-modal"></a>';
