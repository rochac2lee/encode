...
$tipoSolucao      = $_POST['tipo_solucao'];

$descricaoSolucao = utf8_decode($_POST['descricao_solucao']);
...
$dateTimeGLPI    = date('Y-m-d H:i:s');
	...
	$conexao->exec("UPDATE tb_atendimento SET descricao_solucao='$descricaoSolucao', status='6', data_hora_fim='$dateTime' WHERE id = '$id_solicitacao'" );

	//Atualiza o chamado no Helpdesk
	$conexao_glpi->exec("UPDATE glpi_tickets SET closedate='$dateTimeGLPI', solvedate='$dateTimeGLPI', date_mod='$dateTimeGLPI', users_id_lastupdater='$id_usuario', status='6', solutiontypes_id='$tipoSolucao', solution='$descricaoSolucao', global_validation='1' WHERE id = '$id_solicitacao'" );

	//$conexao_glpi->exec("UPDATE glpi_tickets_users SET users_id='$id_usuario', type='2', use_notification='1' WHERE tickets_id = '$id_solicitacao'" );
...
$selectTicket = "SELECT * FROM glpi_tickets where id='$id_solicitacao'";
$resultTicket = $conexao_glpi -> prepare($selectTicket);
$resultTicket -> execute();
$countTicket = $resultTicket->rowCount();

if ($dataTicket = $resultTicket->fetch()) {
	do {

			$viewMotivo          = utf8_decode($dataTicket['name']);
			$viewDataHoraCriacao = date("d/m/Y H:i:s", strtotime($dataTicket['date_creation']));

	} while($dataTicket = $resultTicket->fetch());
}
	...
	if ($data_destinatarios = $resultDestinatarios->fetch(PDO::FETCH_ASSOC)) {
		do {
			...
			$conexao->exec("INSERT INTO tb_notificacao (id_solicitacao, id_destinatario, data_hora_envio, id_notificacao)
											                    VALUES ('$id_solicitacao', '$idDestinatario', '$dateTime', '')" );
			...
			$Email->Subject = utf8_decode("[PLANTÃO TI] - $nome_usuario finalizou o atendimento: $viewMotivo");
			 ...
			 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
			  ...
			  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=600
			   ...
			   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
			    ...
			    <br>
			    </span>".$nome_usuario." finalizou uma Solicitação de Atendimento em ".$dateTime."<o:p></o:p></span></p>
			    <p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'><span
			    style='font-size:11.5pt;font-family:'Arial',sans-serif'>Informações sobre a Solicitação:<b><o:p></o:p></b></span></p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>ID: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$id_solicitacao."</span>
					</p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Início do Atendimento: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$viewDataHoraCriacao."</span>
					</p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Término do Atendimento: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$dateTime."</span>
					</p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Motivo: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$viewMotivo."</span>
					</p>
					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Solução do Problema: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$descricaoSolucao."</span>
					</p>
