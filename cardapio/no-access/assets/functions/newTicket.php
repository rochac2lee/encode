...
$dataSolicitacao      = $_POST['data_criacao'];
$dataSolicitacaoGLPI  = $_POST['data_criacao_glpi'];
$nome                 = $_POST['solicitante'];
$setor                = $_POST['setor'];
$motivo               = $_POST['motivo'];
$descricao            = $_POST['descricao'];

$selectNomeSetor = "SELECT name FROM tb_setores where id = '$setor'";
$resultNomeSetor = $conexao -> prepare($selectNomeSetor);
$resultNomeSetor -> execute();
$countNomeSetor = $resultNomeSetor->rowCount();

if ($data_nomeSetor = $resultNomeSetor->fetch()) {
	do {

		$nomeSetor = $data_nomeSetor['name'];

	} while ($data_nomeSetor = $resultNomeSetor->fetch());
}
...
$dateTime        = date('d/m/Y H:i');
	...
	$conexao->exec("INSERT INTO tb_atendimentos (nome, setor, motivo, descricao, data_solicitacao, id)
					VALUES ('$nome', '$setor', '$motivo', '$descricao', '$dataSolicitacaoGLPI', '')" );
	...
	if ($data_destinatarios = $resultDestinatarios->fetch(PDO::FETCH_ASSOC)) {
		do {
			...
			$conexao->exec("INSERT INTO tb_notificacao (id_solicitacao, id_destinatario, data_hora_envio, id_notificacao)
											                    VALUES ('$lastId', '$idDestinatario', '$dateTime', '')" );
			...
			$Email->Subject = utf8_decode("[PLANTÃO TI] - $nome solicitou um atendimento: $motivo");
			 ...
			 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes'>
			  ...
			  <table class=MsoNormalTable border=0 cellspacing=0 cellpadding=0 width=600
			   ...
			   <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;mso-yfti-lastrow:yes;
			    ...
			    <br>
			    </span>".$nome." fez uma Solicitação de Atendimento para Equipe de TI em ".$dataSolicitacao."<o:p></o:p></span></p>
			    <p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'><span
			    style='font-size:11.5pt;font-family:'Arial',sans-serif'>Informações sobre a Solicitação:<b><o:p></o:p></b></span></p>
					...
					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Data e Hora: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$dataSolicitacao."</span>
					</p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Setor: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$nomeSetor."</span>
					</p>

					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Motivo: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$motivo."</span>
					</p>
					<p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<b><span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Descrição do Problema: </span></b>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>".$descricao."</span>
					</p>
			    ...
			    <p class=MsoNormal style='margin-bottom:12.0pt;line-height:17.25pt'>
						<span style='font-size:11.5pt;font-family:'Arial',sans-serif'>Fique tranquilo(a). Você receberá atualizações sobre essa solicitação automaticamente! <span><br><br>
