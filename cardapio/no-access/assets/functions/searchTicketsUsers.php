...
if ($data = $result->fetch()) {
	...
	if ($tipo > 0) {
    $selectAllTickets = "SELECT * FROM glpi_tickets where
											((users_id_recipient = '$idUsuario' and itilcategories_id = 5) and status = '$tipo') or
											((users_id_recipient = '$idUsuario' and itilcategories_id = 6) and status = '$tipo') or
											((users_id_recipient = '$idUsuario' and itilcategories_id = 7) and status = '$tipo') or
											((users_id_recipient = '$idUsuario' and itilcategories_id = 8) and status = '$tipo') order by id DESC";
	} else {
		$selectAllTickets = "SELECT * FROM glpi_tickets where users_id_recipient = '$idUsuario' and itilcategories_id = 5 or users_id_recipient = '$idUsuario' and itilcategories_id = 6 or users_id_recipient = '$idUsuario' and itilcategories_id = 7 or users_id_recipient = '$idUsuario' and itilcategories_id = 8 order by id DESC";
	}
