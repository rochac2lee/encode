...
$conexao_glpi->exec("INSERT INTO glpi_tickets_users (tickets_id, users_id, type, use_notification, alternative_email, id)
							                         	VALUES ('$id_ticket', '$id_usuario', '2', '1', '$email_usuario',  '')" );
...
if ($data_destinatarios = $resultDestinatarios->fetch(PDO::FETCH_ASSOC)) {
	do {
		...
		$Email->Subject = utf8_decode("[PLANTÃO TI EM ATENDIMENTO] - Solicitação n° $id_ticket atribuído a $nome_usuario");
        ...
        <p class=MsoNormal style='margin-bottom:6.0pt;line-height:17.25pt'>
					<span style='font-size:16pt;font-family:'Arial',sans-serif'>".$nome_usuario." está atendendo essa solicitação nesse momento!</span>
				</p>
        </center>
