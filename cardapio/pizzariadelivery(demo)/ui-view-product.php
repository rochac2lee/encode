				...
				if ($dataEmpresa = $resultEmpresa -> fetch()) {
					do {
						...
						.pill-pedido {
							...
							border: 3px solid $corTexto2!important;
							padding: 8px 15px;
							font-size: 18px;
							font-weight: 600;
	...
	<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12 animated fadeInRight" id="navSolicitacao">
		<div class="card mb-3" style="background: transparent; box-shadow: none;">
			...
			<div class="card-header top_dark" style="height: 180px;">
				<div class="bar" onclick=window.location.href="index.php?cat=<?php echo $cat.''.$link; ?>">
				...
				<div style="width: 70%; margin-left: 12%;position: absolute; z-index: 0">
					<?php echo "<p class='corTexto2'>$nome</p>"; ?>
				</div>
			</div>
			...
			<div class="card-body background_dark" style="border: 0; padding-top: 0;">
					...
					<?php
								...
								echo "
								<center>
									<a data-fancybox='$banner' href='../../sistemaDelivery/assets/uploads/banner/$banner'>
										<img style='object-fit: cover; width: 100%; height: 200px; border-radius: 20px; margin-top: -36%;' src='../../sistemaDelivery/assets/uploads/banner/$banner'>
									</a>
									<div class='card-header card-dark' style='width: 100%;'>
					...
					<?php
								echo "
									<br>
									<div style='width: 100%'>
										<a class='pill-pedido' onclick='incluirPedido();'><i class='fab fa-whatsapp'></i>&nbsp; Fazer Pedido</a>
									</div>
								";
					?>
