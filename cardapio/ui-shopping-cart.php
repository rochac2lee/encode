...
<?php require('assets/includes/conexao.php'); ?>

<body class="background_dark" onload="viewShoppingCart()" style="background-color: #292728!important; z-index: 1000000000;">
...
<div class="row" style="margin: 0;">
	...
	<?php require('assets/includes/shoppingCart.php'); ?>
